...
class DataMgr(object):
    ...
    def bloomberg(self):
        ...
        historical_data = LocalTerminal.get_historical(securities, ['PX_HIGH', 'PX_LOW'], start=self.rundate, end=self.rundate).as_frame()

        historical_bval = LocalTerminal.get_historical(securities, ['PX_ASK', 'PX_BID'], start=self.rundate, end=self.rundate,
